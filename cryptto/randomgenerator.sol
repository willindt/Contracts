...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public crypottoLottery;
     ...
     * @param _seed: seed provided by the Crypotto lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == crypottoLottery, "Only crypottoLottery");
    ...
    /**
     * @notice Set the address for the crypottoLottery
     * @param _crypottoLottery: address of the crypotto lottery
     */
    function setLotteryAddress(address _crypottoLottery) external onlyOwner {
        crypottoLottery = _crypottoLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ICrypottoLottery(crypottoLottery).viewCurrentLotteryId();
    }
}