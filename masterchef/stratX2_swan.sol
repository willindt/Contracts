...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-SWAN staking vault.
    ...
    address public swanFarmAddress;
    address public SWANAddress;
    ...
    address[] public earnedToSWANPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(swanFarmAddress, _wantAmt);
...
contract StratX2_SWAN is StratX2 {
    constructor(
        address _wantAddress
    ) public {
        wbnbAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        govAddress = 0xcC1B3d30322526A43Cf7F49a14a78A29Ed815da6;
        swanFarmAddress = 0x40a06c19F4B7933F2C86C8d30a94A66c63018E40;
        SWANAddress = 0x1bc638ce9DA0A8fE2d5Ff63557206Fa78d661caD;

        wantAddress = _wantAddress;
        token0Address = SWANAddress;
        token1Address = wbnbAddress;
        earnedAddress = 0x0000000000000000000000000000000000000000;
        lockerAddress = 0x189dB184f5e5957DBa28796915b3d2db94D6BD79;
        ...
        transferOwnership(swanFarmAddress);
    }
