// Dependency file: .\TokenDividendTracker.sol
...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "Testosoz_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "Testosoz_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Testosoz contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Testosoz_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Testosoz_Dividend_Tracker: Cannot update claimWait to same value");
