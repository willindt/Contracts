...
contract ASHToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x4844078aF9A48955Ad111a2f0Cc43DFFCD81eba3); // Marketing Address
    ...
    uint256 private _tTotal = 2250000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CoinName";
